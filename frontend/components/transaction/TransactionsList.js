...
const TransactionsList = ({ transactions }) => {
	...
	return (
		<div>
			<div className="rounded-full bg-[#4f5d75] pb-4 pt-10">
				<p className=
						"font-poppins flex items-center justify-center pb-6 mx-auto max-w-3xl px-10 text-sm font-medium uppercase text-[#fff] xl:px-0"
